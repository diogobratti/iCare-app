...
export default class ListagemAnuncio extends Component {
    ...
    renderItem = ({ item }) => (
        <View style={styles.anuncioContainer}>
            <View style={styles.anuncioColunaEsquerdaContainer}>
                <TouchableOpacity 
                ...
                >
                    ...
                    />
                    <Text style={styles.productDescription}>Distancia</Text>
                </TouchableOpacity>
            </View>
            <View style={styles.anuncioColunaDireitaContainer}>
                <TouchableOpacity 
                    //style={styles.productButton} 
                    onPress={() => {
                ...
                >
                    ...
                    <View style={styles.anuncioColunaDireitaLinha}>
                        <Image 
                            style={{width: 25, height: 25}} 
                            source={{uri: 'https://img.freepik.com/free-vector/start_53876-25533.jpg?size=338&ext=jpg'}} 
                        />
                        <Text style={styles.productDescription}>0,5</Text>
                        <Text style={styles.productDescription}> - </Text>
                        <Text style={styles.productDescription}>perfil</Text>
                    </View>
                    <Text style={styles.productDescription}>R$ 1 bi</Text>
                </TouchableOpacity>
            </View>
        </View> 
    )
