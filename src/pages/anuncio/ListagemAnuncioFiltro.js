            ...
            <View style={StyleAnuncio.container}>
                ...
                <View style={StyleAnuncio.filtroContainer}>
                    ...
                    <View style={StyleAnuncio.filtroItemContainer}>
                        ...
                        <Text style={StyleAnuncio.filtroItemSliderTexto}>
                            Até <Ionicons name="ios-star" size={anuncioIconeAvaliacao.size} color={anuncioIconeAvaliacao.color} /> <Text style={StyleAnuncio.anuncioAvaliacao}>{this.state.avaliacaoFiltro}</Text>
                        </Text>
                        <Slider
                            maximumValue={5}
                            minimumValue={0}
