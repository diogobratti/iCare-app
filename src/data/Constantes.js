...
export const LISTAGEM_ANUNCIO_FILTRO_PERFIL_CLIENTE = 'Cliente';
export const LISTAGEM_ANUNCIO_FILTRO_PERFIL_FORNECEDOR = 'Fornecedor';
...
export const ASYNC_GRUPO_ITENS_ANUNCIO_COMPLETO = [
  ...
  ASYNC_ITEM_USUARIO_INSTAGRAM,
  ASYNC_ITEM_USUARIO_EMAIL,
  ASYNC_ITEM_USUARIO_MUNICIPIO
]
...
export const FIRESTORE_FIELD_ANUNCIO_USUARIO_INSTAGRAM = 'instagram';
